function searchGoogleBooks() {
    ...
    if (txtSearch.value == "") {
        ...
        document.querySelector("#mainDiv").innerHTML = "No search keywords provided..."
        return;
    ...
    fetch('https://googleapis.com/books/v1/volumes?q=' + txtSearch.value + "&startIndex=0&maxResults=20")
